...
namespace DataModels
{
	...
	/// Server Version : 11.7
	/// </summary>
	public partial class PayplDB : LinqToDB.Data.DataConnection
	{
		public ITable<Category>                  Categories                 { get { return this.GetTable<Category>(); } }
		public ITable<Chat>                      Chats                      { get { return this.GetTable<Chat>(); } }
		public ITable<ContactService>            ContactServices            { get { return this.GetTable<ContactService>(); } }
		public ITable<ContactServiceUser>        ContactServiceUsers        { get { return this.GetTable<ContactServiceUser>(); } }
		public ITable<Good>                      Goods                      { get { return this.GetTable<Good>(); } }
		public ITable<GoodOrder>                 GoodOrders                 { get { return this.GetTable<GoodOrder>(); } }
		public ITable<MediaType>                 MediaTypes                 { get { return this.GetTable<MediaType>(); } }
		public ITable<Medium>                    Media                      { get { return this.GetTable<Medium>(); } }
		...
		public ITable<OauthAccessToken>          OauthAccessTokens          { get { return this.GetTable<OauthAccessToken>(); } }
		public ITable<OauthAuthCode>             OauthAuthCodes             { get { return this.GetTable<OauthAuthCode>(); } }
		public ITable<OauthClient>               OauthClients               { get { return this.GetTable<OauthClient>(); } }
		public ITable<OauthPersonalAccessClient> OauthPersonalAccessClients { get { return this.GetTable<OauthPersonalAccessClient>(); } }
		public ITable<OauthRefreshToken>         OauthRefreshTokens         { get { return this.GetTable<OauthRefreshToken>(); } }
		public ITable<Order>                     Orders                     { get { return this.GetTable<Order>(); } }
		public ITable<Party>                     Parties                    { get { return this.GetTable<Party>(); } }
		public ITable<PasswordReset>             PasswordResets             { get { return this.GetTable<PasswordReset>(); } }
		public ITable<PayService>                PayServices                { get { return this.GetTable<PayService>(); } }
		public ITable<PayServiceUser>            PayServiceUsers            { get { return this.GetTable<PayServiceUser>(); } }
		public ITable<Request>                   Requests                   { get { return this.GetTable<Request>(); } }
		public ITable<Role>                      Roles                      { get { return this.GetTable<Role>(); } }
		public ITable<Status>                    Statuses                   { get { return this.GetTable<Status>(); } }
		...
		public PayplDB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
	...
	public partial class Category
	{
		...
		[Column("tax"),       NotNull              ] public double Tax      { get; set; } // double precision
		[Column("parent_id"),    Nullable          ] public int?   ParentId { get; set; } // integer
		[Column("slug"),      NotNull              ] public string Slug     { get; set; } // character varying(255)

		#region Associations

		/// <summary>
		/// goods_category_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="CategoryId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Good> Goodscategoryidforeigns { get; set; }

		/// <summary>
		/// categories_parent_id_foreign
		/// </summary>
		[Association(ThisKey="ParentId", OtherKey="Id", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="categories_parent_id_foreign", BackReferenceName="Parentidforeigns")]
		public Category Parent { get; set; }

		/// <summary>
		/// categories_parent_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="ParentId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Category> Parentidforeigns { get; set; }
	...
	{
		[Column("id"),   PrimaryKey, Identity] public int    Id   { get; set; } // integer
		[Column("name"), Nullable            ] public string Name { get; set; } // character varying(255)

		#region Associations

		/// <summary>
		/// messages_chat_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="ChatId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Message> Messageschatidforeigns { get; set; }

		/// <summary>
		/// parties_chat_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="ChatId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Party> Partieschatidforeigns { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="contact_services")]
	public partial class ContactService
	{
		[Column("id"),   PrimaryKey, Identity] public int    Id   { get; set; } // integer
		[Column("name"), NotNull             ] public string Name { get; set; } // character varying(255)
		[Column("link"), NotNull             ] public string Link { get; set; } // character varying(255)
		[Column("icon"), NotNull             ] public string Icon { get; set; } // character varying(255)

		#region Associations

		/// <summary>
		/// contact_service_user_contact_service_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="ContactServiceId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<ContactServiceUser> Contactserviceusercontactserviceidforeigns { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="contact_service_user")]
	public partial class ContactServiceUser
	{
		[Column("id"),                 PrimaryKey, Identity] public int    Id               { get; set; } // integer
		[Column("user_id"),            NotNull             ] public int    UserId           { get; set; } // integer
		[Column("contact_service_id"), NotNull             ] public int    ContactServiceId { get; set; } // integer
		[Column("link"),               NotNull             ] public string Link             { get; set; } // character varying(255)

		#region Associations

		/// <summary>
		/// contact_service_user_contact_service_id_foreign
		/// </summary>
		[Association(ThisKey="ContactServiceId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="contact_service_user_contact_service_id_foreign", BackReferenceName="Contactserviceusercontactserviceidforeigns")]
		public ContactService ContactService { get; set; }

		/// <summary>
		/// contact_service_user_user_id_foreign
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="contact_service_user_user_id_foreign", BackReferenceName="Contactserviceuseruseridforeigns")]
	...
	public partial class Good
	{
		...
		[Column("status_id"),   NotNull              ] public int       StatusId    { get; set; } // integer
		...
		[Column("slug"),           Nullable          ] public string    Slug        { get; set; } // character varying(255)

		#region Associations

		/// <summary>
		/// goods_category_id_foreign
		/// </summary>
		[Association(ThisKey="CategoryId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="goods_category_id_foreign", BackReferenceName="Goodscategoryidforeigns")]
		public Category Category { get; set; }

		/// <summary>
		/// good_order_good_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="GoodId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<GoodOrder> Goodordergoodidforeigns { get; set; }

		/// <summary>
		/// media_good_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="GoodId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Medium> Mediagoodidforeigns { get; set; }

		/// <summary>
		/// goods_status_id_foreign
		/// </summary>
		[Association(ThisKey="StatusId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="goods_status_id_foreign", BackReferenceName="Goodsstatusidforeigns")]
		public Status Status { get; set; }

		/// <summary>
		/// goods_user_id_foreign
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="goods_user_id_foreign", BackReferenceName="Goodsuseridforeigns")]
		public User User { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="good_order")]
	public partial class GoodOrder
	{
		[Column("id"),            PrimaryKey, Identity] public int    Id           { get; set; } // integer
		[Column("good_id"),       NotNull             ] public int    GoodId       { get; set; } // integer
		[Column("order_id"),      NotNull             ] public int    OrderId      { get; set; } // integer
		[Column("quantity"),      NotNull             ] public int    Quantity     { get; set; } // integer
		[Column("price_current"), NotNull             ] public double PriceCurrent { get; set; } // double precision
		[Column("tax_current"),   NotNull             ] public double TaxCurrent   { get; set; } // double precision

		#region Associations

		/// <summary>
		/// good_order_good_id_foreign
		/// </summary>
		[Association(ThisKey="GoodId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="good_order_good_id_foreign", BackReferenceName="Goodordergoodidforeigns")]
		public Good Good { get; set; }

		/// <summary>
		/// good_order_order_id_foreign
		/// </summary>
		[Association(ThisKey="OrderId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="good_order_order_id_foreign", BackReferenceName="Goodorderorderidforeigns")]
		public Order Order { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="media_types")]
	public partial class MediaType
	{
		[Column("id"),         PrimaryKey, Identity] public int    Id         { get; set; } // integer
		[Column("name"),       NotNull             ] public string Name       { get; set; } // character varying(255)
		[Column("extensions"), NotNull             ] public string Extensions { get; set; } // character varying(255)

		#region Associations

		/// <summary>
		/// media_media_type_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="MediaTypeId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Medium> Mediamediatypeidforeigns { get; set; }
	...
	public partial class Medium
	{
		...
		[Column("good_id"),       NotNull              ] public int    GoodId      { get; set; } // integer
		[Column("link"),          NotNull              ] public string Link        { get; set; } // character varying(255)
		[Column("media_type_id"), NotNull              ] public int    MediaTypeId { get; set; } // integer
		[Column("description"),      Nullable          ] public string Description { get; set; } // text

		#region Associations

		/// <summary>
		/// media_good_id_foreign
		/// </summary>
		[Association(ThisKey="GoodId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="media_good_id_foreign", BackReferenceName="Mediagoodidforeigns")]
		public Good Good { get; set; }

		/// <summary>
		/// media_media_type_id_foreign
		/// </summary>
		[Association(ThisKey="MediaTypeId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="media_media_type_id_foreign", BackReferenceName="Mediamediatypeidforeigns")]
	...
	public partial class Message
	{
		...
		[Column("user_id"),    NotNull              ] public int       UserId    { get; set; } // integer
		[Column("chat_id"),    NotNull              ] public int       ChatId    { get; set; } // integer
		[Column("created_at"),    Nullable          ] public DateTime? CreatedAt { get; set; } // timestamp (0) without time zone
		[Column("updated_at"),    Nullable          ] public DateTime? UpdatedAt { get; set; } // timestamp (0) without time zone
		...
		/// </summary>
		[Association(ThisKey="ChatId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="messages_chat_id_foreign", BackReferenceName="Messageschatidforeigns")]
		public Chat Chat { get; set; }

		/// <summary>
		/// messages_user_id_foreign
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="messages_user_id_foreign", BackReferenceName="Messagesuseridforeigns")]
		public User User { get; set; }
	...
	{
		[Column("id"),        PrimaryKey, Identity] public int    Id              { get; set; } // integer
		[Column("migration"), NotNull             ] public string MigrationColumn { get; set; } // character varying(255)
		[Column("batch"),     NotNull             ] public int    Batch           { get; set; } // integer
	}

	[Table(Schema="public", Name="oauth_access_tokens")]
	public partial class OauthAccessToken
	{
		[Column("id"),         PrimaryKey,  NotNull] public string    Id        { get; set; } // character varying(100)
		[Column("user_id"),       Nullable         ] public long?     UserId    { get; set; } // bigint
		[Column("client_id"),               NotNull] public long      ClientId  { get; set; } // bigint
		[Column("name"),          Nullable         ] public string    Name      { get; set; } // character varying(255)
		[Column("scopes"),        Nullable         ] public string    Scopes    { get; set; } // text
		[Column("revoked"),                 NotNull] public bool      Revoked   { get; set; } // boolean
		[Column("created_at"),    Nullable         ] public DateTime? CreatedAt { get; set; } // timestamp (0) without time zone
		[Column("updated_at"),    Nullable         ] public DateTime? UpdatedAt { get; set; } // timestamp (0) without time zone
		[Column("expires_at"),    Nullable         ] public DateTime? ExpiresAt { get; set; } // timestamp (0) without time zone
	}

	[Table(Schema="public", Name="oauth_auth_codes")]
	...
	[Table(Schema="public", Name="oauth_clients")]
	public partial class OauthClient
	{
		[Column("id"),                     PrimaryKey,  Identity] public long      Id                   { get; set; } // bigint
		[Column("user_id"),                   Nullable          ] public long?     UserId               { get; set; } // bigint
		[Column("name"),                   NotNull              ] public string    Name                 { get; set; } // character varying(255)
		[Column("secret"),                    Nullable          ] public string    Secret               { get; set; } // character varying(100)
		[Column("redirect"),               NotNull              ] public string    Redirect             { get; set; } // text
		[Column("personal_access_client"), NotNull              ] public bool      PersonalAccessClient { get; set; } // boolean
		[Column("password_client"),        NotNull              ] public bool      PasswordClient       { get; set; } // boolean
		[Column("revoked"),                NotNull              ] public bool      Revoked              { get; set; } // boolean
		[Column("created_at"),                Nullable          ] public DateTime? CreatedAt            { get; set; } // timestamp (0) without time zone
		[Column("updated_at"),                Nullable          ] public DateTime? UpdatedAt            { get; set; } // timestamp (0) without time zone
	}

	[Table(Schema="public", Name="oauth_personal_access_clients")]
	...
	[Table(Schema="public", Name="oauth_refresh_tokens")]
	public partial class OauthRefreshToken
	{
		[Column("id"),              PrimaryKey,  NotNull] public string    Id            { get; set; } // character varying(100)
		[Column("access_token_id"),              NotNull] public string    AccessTokenId { get; set; } // character varying(100)
		[Column("revoked"),                      NotNull] public bool      Revoked       { get; set; } // boolean
		[Column("expires_at"),         Nullable         ] public DateTime? ExpiresAt     { get; set; } // timestamp (0) without time zone
	}
	...
	public partial class Order
	{
		...
		[Column("user_id"),    NotNull              ] public int       UserId    { get; set; } // integer
		[Column("status_id"),  NotNull              ] public int       StatusId  { get; set; } // integer
		[Column("token"),      NotNull              ] public string    Token     { get; set; } // character varying(255)
		[Column("created_at"),    Nullable          ] public DateTime? CreatedAt { get; set; } // timestamp (0) without time zone
		[Column("updated_at"),    Nullable          ] public DateTime? UpdatedAt { get; set; } // timestamp (0) without time zone
		...
		/// <summary>
		/// good_order_order_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="OrderId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<GoodOrder> Goodorderorderidforeigns { get; set; }

		/// <summary>
		/// orders_status_id_foreign
		/// </summary>
		[Association(ThisKey="StatusId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="orders_status_id_foreign", BackReferenceName="Ordersstatusidforeigns")]
		public Status Status { get; set; }

		/// <summary>
		/// orders_user_id_foreign
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="orders_user_id_foreign", BackReferenceName="Ordersuseridforeigns")]
		public User User { get; set; }
	...
	public partial class Party
	{
		...
		/// <summary>
		/// parties_chat_id_foreign
		/// </summary>
		[Association(ThisKey="ChatId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="parties_chat_id_foreign", BackReferenceName="Partieschatidforeigns")]
		public Chat Chat { get; set; }

		/// <summary>
		/// parties_user_id_foreign
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="parties_user_id_foreign", BackReferenceName="Partiesuseridforeigns")]
		public User User { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="password_resets")]
	...
	[Table(Schema="public", Name="pay_services")]
	public partial class PayService
	{
		...
		/// <summary>
		/// pay_service_user_pay_service_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="PayServiceId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<PayServiceUser> Payserviceuserpayserviceidforeigns { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="pay_service_user")]
	public partial class PayServiceUser
	{
		[Column("id"),             PrimaryKey, Identity] public int    Id           { get; set; } // integer
		[Column("user_id"),        NotNull             ] public int    UserId       { get; set; } // integer
		[Column("pay_service_id"), NotNull             ] public int    PayServiceId { get; set; } // integer
		[Column("link"),           NotNull             ] public string Link         { get; set; } // character varying(255)

		#region Associations

		/// <summary>
		/// pay_service_user_pay_service_id_foreign
		/// </summary>
		[Association(ThisKey="PayServiceId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="pay_service_user_pay_service_id_foreign", BackReferenceName="Payserviceuserpayserviceidforeigns")]
		public PayService PayService { get; set; }

		/// <summary>
		/// pay_service_user_user_id_foreign
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="pay_service_user_user_id_foreign", BackReferenceName="Payserviceuseruseridforeigns")]
		public User User { get; set; }
	...
	public partial class Request
	{
		...
		/// <summary>
		/// requests_status_id_foreign
		/// </summary>
		[Association(ThisKey="StatusId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="requests_status_id_foreign", BackReferenceName="Requestsstatusidforeigns")]
		public Status Status { get; set; }

		/// <summary>
		/// requests_user_id_foreign
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="Id", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="requests_user_id_foreign", BackReferenceName="Requestsuseridforeigns")]
		public User User { get; set; }
	...
	public partial class Role
	{
		...
		/// <summary>
		/// users_role_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="RoleId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<User> Usersroleidforeigns { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="statuses")]
	public partial class Status
	{
		[Column("id"),     PrimaryKey, Identity] public int    Id     { get; set; } // integer
		[Column("name"),   NotNull             ] public string Name   { get; set; } // character varying(255)
		[Column("type"),   NotNull             ] public string Type   { get; set; } // character varying(255)
		[Column("locked"), NotNull             ] public bool   Locked { get; set; } // boolean

		#region Associations

		/// <summary>
		/// goods_status_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="StatusId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Good> Goodsstatusidforeigns { get; set; }

		/// <summary>
		/// orders_status_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="StatusId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Order> Ordersstatusidforeigns { get; set; }

		/// <summary>
		/// requests_status_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="StatusId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Request> Requestsstatusidforeigns { get; set; }
	...
	public partial class User
	{
		[Column("id"),                PrimaryKey,  Identity] public int       Id              { get; set; } // integer
		[Column("name"),              NotNull              ] public string    Name            { get; set; } // character varying(255)
		[Column("login"),             NotNull              ] public string    Login           { get; set; } // character varying(255)
		[Column("email"),             NotNull              ] public string    Email           { get; set; } // character varying(255)
		[Column("email_verified_at"),    Nullable          ] public DateTime? EmailVerifiedAt { get; set; } // timestamp (0) without time zone
		[Column("password"),          NotNull              ] public string    Password        { get; set; } // character varying(255)
		[Column("avatar"),               Nullable          ] public string    Avatar          { get; set; } // character varying(255)
		[Column("balance"),           NotNull              ] public double    Balance         { get; set; } // double precision
		[Column("role_id"),              Nullable          ] public int?      RoleId          { get; set; } // integer
		[Column("rating"),               Nullable          ] public double?   Rating          { get; set; } // double precision
		[Column("remember_token"),       Nullable          ] public string    RememberToken   { get; set; } // character varying(100)
		[Column("created_at"),           Nullable          ] public DateTime? CreatedAt       { get; set; } // timestamp (0) without time zone
		[Column("updated_at"),           Nullable          ] public DateTime? UpdatedAt       { get; set; } // timestamp (0) without time zone
		...
		/// <summary>
		/// contact_service_user_user_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<ContactServiceUser> Contactserviceuseruseridforeigns { get; set; }

		/// <summary>
		/// goods_user_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Good> Goodsuseridforeigns { get; set; }

		/// <summary>
		/// messages_user_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Message> Messagesuseridforeigns { get; set; }

		/// <summary>
		/// orders_user_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Order> Ordersuseridforeigns { get; set; }

		/// <summary>
		/// parties_user_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Party> Partiesuseridforeigns { get; set; }

		/// <summary>
		/// pay_service_user_user_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<PayServiceUser> Payserviceuseruseridforeigns { get; set; }

		/// <summary>
		/// requests_user_id_foreign_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Request> Requestsuseridforeigns { get; set; }

		/// <summary>
		/// users_role_id_foreign
		/// </summary>
		[Association(ThisKey="RoleId", OtherKey="Id", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="users_role_id_foreign", BackReferenceName="Usersroleidforeigns")]
	...
	public static partial class TableExtensions
	{
		...
		public static Chat Find(this ITable<Chat> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static ContactService Find(this ITable<ContactService> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static ContactServiceUser Find(this ITable<ContactServiceUser> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}
		...
		public static GoodOrder Find(this ITable<GoodOrder> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static MediaType Find(this ITable<MediaType> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static Medium Find(this ITable<Medium> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}
		...
		public static Migration Find(this ITable<Migration> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static OauthAccessToken Find(this ITable<OauthAccessToken> table, string Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static OauthAuthCode Find(this ITable<OauthAuthCode> table, string Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static OauthClient Find(this ITable<OauthClient> table, long Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static OauthPersonalAccessClient Find(this ITable<OauthPersonalAccessClient> table, long Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static OauthRefreshToken Find(this ITable<OauthRefreshToken> table, string Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}
		...
		public static Party Find(this ITable<Party> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static PayService Find(this ITable<PayService> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static PayServiceUser Find(this ITable<PayServiceUser> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}
